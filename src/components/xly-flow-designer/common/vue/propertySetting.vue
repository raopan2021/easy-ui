...
import start from '@/components/xly-flow-designer/common/vue/start.vue'
import between from '@/components/xly-flow-designer/common/vue/between.vue'
import serial from '@/components/xly-flow-designer/common/vue/gateway.vue'
import parallel from '@/components/xly-flow-designer/common/vue/gateway.vue'
import end from '@/components/xly-flow-designer/common/vue/end.vue'
import skip from '@/components/xly-flow-designer/common/vue/skip.vue'
      ...
      if (n.type === 'skip') {
        ...
        if (!n.properties.collaborativeWay) {
          ...
          n.properties.collaborativeWay =
            parseFloat(nodeRatio) === 0
              ? '1'
              : parseFloat(nodeRatio) === 100
                ? '3'
                : nodeRatio
                  ? '2'
                  : '1'
