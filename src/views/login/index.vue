...
import type { ThemeConfig } from './components/ThemeSwitcher.vue'
...
<template>
  <div class="login-root">
    ...
    <!-- 主题渲染 -->
    <component :is="currentComponent" :key="currentTheme" :loading="loading" :error="errorMsg" @submit="handleLogin" />
  </div>
</template>
