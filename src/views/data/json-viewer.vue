  ...
  data: {
    records: [
      ...
      },
      {
        ...
        status: 'INACTIVE',
        createTime: '2026-02-20 14:22:00',
      },
      {
        id: 3,
        name: '王五',
  ...
  <div class="json-viewer-doc">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        传入 <code>data</code> 属性即可展示 JSON 数据，组件自动解析并渲染。支持对象、数组、字符串、数字、布尔值、null
        等数据类型。
      </p>
    ...
    <section class="doc-section">
      <h2 class="doc-section__title">
        深度控制 <code>depth</code>
      </h2>
      <p class="doc-section__desc">
        通过 <code>depth</code> 属性控制默认展开深度。设为 <code>0</code> 则默认全部展开，设为
        <code>1</code> 则只展开第一层。
      </p>
      <div class="doc-preview">
...
<EasyJsonViewer :data=&quot;jsonData&quot; :show-expand=&quot;false&quot; />"
      ...
      <div class="doc-tip">
        <strong>去除工具栏：</strong>如不需要工具栏，找到组件模板中带注释
        <code>&lt;!-- 🔌</code> 的代码块，删除对应行即可。具体位置：
        <pre
          style="
            margin: 8px 0;
            padding: 10px 14px;
