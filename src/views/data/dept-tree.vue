...
// 处理选择2
function handleSelect2(node: any) {
  currentId.value = node.id
}

// 处理展开/折叠
function handleToggle(node: any, expanded: boolean) {
...
<template>
  <div class="dept-tree-doc">
    ...
    <section class="doc-section">
      <h2 class="doc-section__title">
        默认展开层级 <code>default-expand-level</code>
      </h2>
      <p class="doc-section__desc">
...
<XlyDeptTree :data=&quot;treeData&quot; :default-expand-level=&quot;0&quot; />"
    ...
    <section class="doc-section">
      <h2 class="doc-section__title">
        高亮当前选中 <code>highlight-current</code>
      </h2>
      <p class="doc-section__desc">
