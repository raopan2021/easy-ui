...
<template>
  <div class="icon-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-desc">
        统一的图标组件，通过 <code>name</code> 前缀区分类型： <code>el:</code> Element Plus 图标、<code>svg:</code>
        自定义 SVG 图标、 无前缀自动识别为图片 URL。使用时无需在页面中引入图标库。
      </p>
    </div>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        使用 <code>el:</code> 前缀 + Element Plus 图标名称（PascalCase 或 kebab-case），组件会自动渲染对应的图标。
      </p>
