  ...
  <div class="component-doc">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>v-model</code> 绑定评分值，默认最多 5 颗星。
      </p>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>allow-half</code> 属性支持选中半星，鼠标移到星星左半侧时显示半选状态。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="display: flex; align-items: center; gap: 12px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>color</code> 和 <code>voidColor</code> 自定义选中和未选中的颜色。
      </p>
      <div class="doc-preview">
...
<XlyRate v-model=&quot;value&quot; color=&quot;#67c23a&quot; />"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>show-text</code> 显示数字，或通过 <code>texts</code> 传入自定义文案数组。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 16px">
...
<XlyRate v-model=&quot;value&quot; :texts=&quot;['很差', '一般', '不错', '推荐', '极佳']&quot; />"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>disabled</code> 属性后评分不可交互。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
      ...
      <div class="doc-table">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>voidColor</code></td>
              <td>未选中颜色</td>
              <td><code>string</code></td>
              <td><code>'#e2e4ed'</code></td>
            </tr>
            <tr>
