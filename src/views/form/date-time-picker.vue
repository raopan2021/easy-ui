...
import { EasyDateTimePicker } from '@raopan/easy-ui'
import { ref } from 'vue'
...
<template>
  <div class="component-doc">
    <header class="doc-header">
      ...
      <p class="doc-desc">
        在同一个面板中同时选择日期和时间，适用于需要精确记录操作时间的场景。
      </p>
    </header>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        点击输入框弹出面板，左侧选择日期，右侧滚动选择时间，点击"确定"完成选择。
      </p>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>show-seconds</code> 属性后，时间列会增加秒的选择，输出格式包含秒。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 300px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>format</code> 属性自定义输出格式，支持
        <code>YYYY</code>、<code>MM</code>、<code>DD</code>、<code>HH</code>、<code>mm</code>、<code>ss</code> 占位符。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 300px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>disabled</code> 禁用，<code>clearable</code> 允许清除已选值。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 300px">
...
<EasyDateTimePicker v-model=&quot;value&quot; size=&quot;small&quot; />"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        面板中的时间区域支持手动输入。点击时间输入框后，可直接键入数字修改时/分/秒的值，支持 <kbd>↑</kbd>
        <kbd>↓</kbd> 键调整数值，<kbd>Enter</kbd> 跳转到下一个输入框。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 300px">
