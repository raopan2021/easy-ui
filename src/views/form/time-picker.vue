...
import { EasyTimePicker } from '@raopan/easy-ui'
import { ref } from 'vue'
...
<template>
  <div class="component-doc">
    <header class="doc-header">
      ...
      <p class="doc-desc">
        用于选择或输入时间，支持时/分/秒选择、滚轮滚动、"此刻"快捷操作。
      </p>
    </header>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        默认只选择时和分，点击输入框弹出时间面板，滚轮或点击选择时间。
      </p>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>show-seconds</code> 属性后，面板中会增加秒的选择列。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 240px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>disabled</code> 禁用，<code>clearable</code> 允许清除已选时间。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 240px">
