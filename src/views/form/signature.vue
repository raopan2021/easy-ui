...
<template>
  <div class="sig-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-desc">
        独立的手写签名画板组件，支持鼠标和触摸绘制、画笔自定义、撤销、清空、导出签名图片。
      </p>
    </div>
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>showPenColor</code> 开启颜色选择器，或使用 <code>penColor</code> 直接指定画笔颜色。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>canvasBgColor</code> 设置画布背景色。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        隐藏工具栏，通过 <code>ref</code> 调用方法控制画板。适用于嵌入到自定义弹窗或表单中。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <div class="sig-demo" style="max-width: 500px">
            ...
            <div class="sig-actions">
              ...
              <button class="sig-action-btn" @click="pureSigRef?.clear()">
                清空
              </button>
              <button class="sig-action-btn sig-action-btn--primary" @click="handlePureConfirm">
                获取签名
              </button>
            </div>
          </div>
...
<button @click=&quot;sigRef?.getDataUrl()&quot;>获取签名</button>"
    ...
    <section v-if="signatureDataUrl" class="doc-section">
      ...
      <p class="doc-section__desc">
        确认签名后获取到的 PNG 图片 dataURL：
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <div class="sig-preview">
            <img :src="signatureDataUrl" alt="签名预览" class="sig-preview__img">
            <p class="sig-preview__size">
              大小：{{ formatDataUrlSize(signatureDataUrl) }}
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="doc-table">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>penSize</code></td>
              <td>画笔粗细（像素）</td>
              <td><code>number</code></td>
              <td><code>2</code></td>
            </tr>
            <tr>
              <td><code>canvasBgColor</code></td>
              <td>画布背景色</td>
              <td><code>string</code></td>
            ...
            <tr>
              <td><code>showPenSize</code></td>
              <td>是否显示画笔粗细选择</td>
              <td><code>boolean</code></td>
              <td><code>true</code></td>
            </tr>
            <tr>
              <td><code>showPenColor</code></td>
              <td>是否显示画笔颜色选择</td>
              <td><code>boolean</code></td>
              <td><code>false</code></td>
            </tr>
            <tr>
              <td><code>showUndo</code></td>
              <td>是否显示撤销按钮</td>
              <td><code>boolean</code></td>
              <td><code>true</code></td>
            </tr>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>点击确认按钮时触发</td>
              <td><code>dataUrl: string</code></td>
            </tr>
            <tr>
              <td><code>change</code></td>
              <td>签名内容变化时触发</td>
              <td><code>hasContent: boolean</code></td>
            </tr>
            <tr>
      ...
      <div class="doc-table">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>confirm()</code></td>
              <td>确认签名（触发 confirm 事件）</td>
              <td>-</td>
            </tr>
            <tr>
              <td><code>getDataUrl()</code></td>
              <td>获取签名图片 dataURL</td>
              <td>-</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><code>setPenSize(size)</code></td>
              <td>设置画笔粗细</td>
      ...
      <div class="doc-table">
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>toolbar-right</code></td>
              <td>工具栏右侧自定义内容（覆盖默认确认按钮）</td>
            </tr>
          </tbody>
        </table>
      </div>
