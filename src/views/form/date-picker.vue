...
<template>
  <div class="component-doc">
    <header class="doc-header">
      ...
      <p class="doc-desc">
        用于选择或输入日期，支持日期、月份、年份三种模式，自带日历面板。
      </p>
    </header>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>type="month"</code> 切换为月份选择模式。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 280px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>type="year"</code> 切换为年份选择模式。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 280px">
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>disabled</code> 禁用，<code>clearable</code> 允许清除已选日期。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: flex-start; gap: 12px">
          <div style="width: 280px">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>选择器类型</td>
              <td><code>'date' | 'month' | 'year'</code></td>
