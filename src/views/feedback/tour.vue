...
<template>
  <div class="tour-doc">
    <div class="doc-header">
      ...
      <p class="doc-desc">
        用于引导用户了解页面功能，支持高亮目标元素、步骤导航、自定义位置和主题色。
      </p>
    </div>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>v-model</code> 控制引导显示，配置 <code>steps</code> 定义引导步骤。
      </p>
  ...
  />
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>placement</code> 属性控制气泡出现位置，支持 top / bottom / left / right
        四个方向，空间不足时自动翻转。
      </p>
      <div class="doc-preview">
          ...
          <div class="placement-demo">
            <div class="placement-demo__area">
              ...
              <div class="placement-demo__row">
                ...
                <div class="placement-demo__spacer" />
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>color</code> 属性自定义主题色，影响按钮和步骤索引。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body doc-preview__body--column">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>xly.$tour</code> 快速启动引导，无需在模板中写组件。统一入口：<code>import { xly } from 'easy-ui'</code>
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body doc-preview__body--column">
...
xly.$tour({
  ...
  color: '#4f6ef7'
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>:mask="false"</code> 可关闭遮罩高亮，适用于轻量提示场景。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
