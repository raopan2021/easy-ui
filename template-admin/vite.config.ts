...
import { type UserConfigExport, type ConfigEnv, loadEnv } from "vite-plus";
import {
  root,
  alias,
  wrapperEnv,
...
export default ({ mode }: ConfigEnv): UserConfigExport => {
  ...
  return {
    ...
    optimizeDeps: {
      ...
      include: [
        "qs", "mitt", "dayjs", "axios",
        "pinia", "vue-types", "js-cookie", "vue-tippy", "pinyin-pro",
        "sortablejs", "@vueuse/core", "@pureadmin/utils", "responsive-storage",
      ],
