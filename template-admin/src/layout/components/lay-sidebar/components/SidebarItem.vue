...
import { ArrowLeftBold as ArrowLeft, ArrowRightBold as ArrowRight, ArrowUpBold as ArrowUp, ArrowDownBold as EpArrowDown } from '@element-plus/icons-vue'
  ...
  >
    <el-menu-item :index="resolvePath(onlyOneChild.path)" :class="{ 'submenu-title-noDropdown': !isNest }"
      ...
      <el-text
        ...
        " truncated class="w-full! px-3! min-w-[54px]! text-center! text-inherit!"
      >
