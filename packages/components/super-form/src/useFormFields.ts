...
export function useFormFields() {
  ...
  /** 日期选择 */
  function datePicker(prop: string, labelOrOptions?: string | FieldOptions, options?: FieldOptions) {
    const { label, ...rest } = normalizeOptions(labelOrOptions, options)
  ...
  function dateRangePicker(
    ...
    if (typeof labelOrStart === 'string' && typeof startPropOrOptions === 'string' && typeof endProp === 'string') {
    ...
    if (typeof labelOrStart === 'string' && typeof startPropOrOptions === 'string') {
      return createChainField(prop, 'dateRangePicker', {
  ...
  /** 日期时间选择 */
  function dateTimePicker(prop: string, labelOrOptions?: string | FieldOptions, options?: FieldOptions) {
    const { label, ...rest } = normalizeOptions(labelOrOptions, options)
  ...
  /** 时间选择 */
  function timePicker(prop: string, labelOrOptions?: string | FieldOptions, options?: FieldOptions) {
    const { label, ...rest } = normalizeOptions(labelOrOptions, options)
  ...
  /** 规范化参数 */
  function normalizeOptions(labelOrOptions?: string | FieldOptions, options?: FieldOptions): FieldOptions {
  ...
  /** 创建自定义字段（使用自定义组件） */
  function custom(prop: string, component: Component, labelOrOptions?: string | FieldOptions, options?: FieldOptions) {
    const { label, ...rest } = normalizeOptions(labelOrOptions, options)
  ...
  /** 图片上传 */
  function imageUpload(prop: string, labelOrOptions?: string | FieldOptions, options?: FieldOptions) {
    const { label, ...rest } = normalizeOptions(labelOrOptions, options)
  ...
  /** 从字段数组提取指定 prop 的值 */
  function pick<T = any>(formData: Record<string, any>, fields: ChainField[], props: (keyof T)[]): T {
    const result: any = {}
