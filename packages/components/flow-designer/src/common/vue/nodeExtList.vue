...
import { useNodeExtList } from './use-node-ext-list'
...
const { form, nodeExtRef, validate } = useNodeExtList(props)

defineExpose({ validate })

export type { NodeExtListProps } from './node-ext-list-types'
</script>
...
<style scoped src="./node-ext-list-style.scss" lang="scss"></style>
