  ...
  >
    <div class="top-section">
      <div class="node-header">
        ...
        <ElInput
          v-show="editingNodeName" ref="nodeNameInput" v-model="nodeName" size="small" class="node-name-input"
          @blur="saveNodeName"
        />
        <span
    ...
    <div class="bottom-section" :title="handler" @click="editNode">
      ...
      <div class="edit-indicator">
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path
            d="M9.33335 4.66666L8.00002 3.33333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M5.66669 9.33333L4.33335 8.00002" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            stroke-linejoin="round"
          />
        </svg>
      </div>
