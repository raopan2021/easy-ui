      ...
      <div class="xly-image-cropper__group">
        <el-tooltip content="左右翻转" placement="top">
          <button class="xly-image-cropper__btn" @click="onScaleX">
            ...
            >
              <path
                d="M8 3H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h3M16 3h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-3M12 20v2M12 2v2"
              />
            </svg>
            <span>镜像</span>
          </button>
        ...
        <el-tooltip content="上下翻转" placement="top">
          <button class="xly-image-cropper__btn" @click="onScaleY">
            ...
            >
              <path
                d="M3 8V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3M3 16v3a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3M20 12H4M2 12h2"
              />
            </svg>
            <span>翻转</span>
          </button>
