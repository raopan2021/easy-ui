...
/** 最大可偏移量 */
const maxScrollOffsetX = computed(() => (scrollable.value ? Math.max(0, virtualPlotWidth.value - plotWidth.value) : 0))
...
.easy-chart__download-btn {
  ...
  &:hover {
    ...
    color: var(--el-text-color-primary);
    border-color: var(--el-border-color-darker); // darken(var(--el-border-color), 5%) → var(--el-border-color)=#e4e4e7
  }
  &:active {
    background: #ebebee;
