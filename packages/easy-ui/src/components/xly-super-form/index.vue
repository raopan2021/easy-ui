...
import XlyCol from '../xly-col/index.vue'
...
import XlyImageUpload from '../xly-image-upload/index.vue'
import XlyInput from '../xly-input/index.vue'
import XlyRate from '../xly-rate/index.vue'
import XlyRow from '../xly-row/index.vue'
import XlySelect from '../xly-select/index.vue'
import XlySwitch from '../xly-switch/index.vue'
import XlyTimePicker from '../xly-time-picker/index.vue'
import XlyTimeRangePicker from '../xly-time-range-picker/index.vue'
import XlyUserPicker from '../xly-user-picker/index.vue'
