...
const avatarClass = computed(() => [`xly-avatar--${props.size}`, `xly-avatar--${props.shape}`, props.customClass])
...
<template>
  <div class="xly-avatar" :class="avatarClass" :style="avatarStyle" @click="handleClick">
    <img
