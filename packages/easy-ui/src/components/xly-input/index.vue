...
import type { FormItemContext } from '../xly-form/utils'
...
.xly-input {
  ...
  // ========== 尺寸 ==========
  &.xly-input--large .xly-input__wrapper {
    height: 44px;
  }

  &.xly-input--large .xly-input__inner {
    font-size: 15px;
  }

  &.xly-input--large .xly-input__prepend,
  &.xly-input--large .xly-input__append {
    font-size: 14px;
  }

  &.xly-input--default .xly-input__wrapper {
    height: 36px;
  }

  &.xly-input--default .xly-input__inner {
    font-size: 14px;
  }

  &.xly-input--default .xly-input__prepend,
  &.xly-input--default .xly-input__append {
    font-size: 14px;
  }

  &.xly-input--small .xly-input__wrapper {
    height: 30px;
  }

  &.xly-input--small .xly-input__inner {
    font-size: 13px;
  }

  &.xly-input--small .xly-input__prepend,
  &.xly-input--small .xly-input__append {
    font-size: 12px;
  }
  ...
  .xly-input__prepend + .xly-input__wrapper {
    border-radius: 0 $radius $radius 0;
  }
