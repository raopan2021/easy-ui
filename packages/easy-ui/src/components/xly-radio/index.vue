...
.xly-radio {
  ...
  // 尺寸
  &.xly-radio--large .xly-radio__inner {
    width: 18px;
    height: 18px;
  }
  &.xly-radio--large .xly-radio__dot {
    width: 8px;
    height: 8px;
  }
  &.xly-radio--large .xly-radio__label {
    font-size: 15px;
  }

  &.xly-radio--default .xly-radio__inner {
    width: 16px;
    height: 16px;
  }
  &.xly-radio--default .xly-radio__dot {
    width: 6px;
    height: 6px;
  }
  &.xly-radio--default .xly-radio__label {
    font-size: 14px;
  }

  &.xly-radio--small .xly-radio__inner {
    width: 14px;
    height: 14px;
  }
  &.xly-radio--small .xly-radio__dot {
    width: 5px;
    height: 5px;
  }
  &.xly-radio--small .xly-radio__label {
    font-size: 13px;
  }
