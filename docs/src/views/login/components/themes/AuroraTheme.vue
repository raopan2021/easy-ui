    ...
    <div class="t-aurora__layout">
      ...
      <div class="t-aurora__left">
        <div class="left-content">
          ...
          <p class="left-desc">
            融合前沿科技与人文关怀，构建企业级数字健康生态，让每位员工都能享受专业化的健康守护。
          </p>
          ...
          <form class="aurora-form" @submit.prevent="handleSubmit">
            <div class="af-field">
              ...
              <div class="af-input-wrap">
                ...
                <input v-model="form.username" type="text" class="af-input" placeholder="请输入账号" autocomplete="username">
              </div>
            </div>
            ...
            <div class="af-field">
              ...
              <div class="af-input-wrap">
                ...
                <input
                  v-model="form.password" :type="showPwd ? 'text' : 'password'" class="af-input af-input--pwd"
                  placeholder="请输入密码" autocomplete="current-password"
                >
                <button type="button" class="af-toggle" @click="showPwd = !showPwd">
                  <svg
                    v-if="!showPwd" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                    width="16" height="16"
                  >
            ...
            <!-- 登录按钮 -->
            <button
              type="submit" class="af-btn" :class="{ 'af-btn--loading': loading }"
...
.orbit-dot {
  ...
  &.orbit-dot--2 {
    ...
    animation: dot-orbit 12s linear infinite reverse;
  }
}
@keyframes dot-orbit {
  from {
    transform: translateX(-50%) rotate(0) translateX(42px) rotate(0);
  }
  to {
    transform: translateX(-50%) rotate(360deg) translateX(42px) rotate(-360deg);
  }
}
...
.af-btn {
  ...
  .af-btn-spinner {
    ...
    svg {
      width: 18px;
      height: 18px;
      animation: lf-rotate 0.75s linear infinite;
    }
  }
