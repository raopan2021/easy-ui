        ...
        <form class="classic-form" @submit.prevent="handleSubmit">
          <div class="cf-field">
            ...
            <div class="cf-input-wrap">
              ...
              <input v-model="form.username" type="text" class="cf-input" placeholder="请输入账号" autocomplete="username">
            </div>
          </div>
          ...
          <button type="submit" class="cf-btn" :disabled="loading || !form.username || !form.password">
...
.blob {
  ...
  &.blob--2 {
    ...
    bottom: -150px;
    left: -100px;
    animation: fb 25s ease-in-out infinite;
  }
  &.blob--3 {
    width: 300px;
    height: 300px;
    ...
    top: 50%;
    left: 40%;
    animation: fc 18s ease-in-out infinite;
  }
}
