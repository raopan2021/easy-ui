...
const columns = [
  ...
  { prop: 'status', name: '状态' },
    ...
    <section class="doc-section">
      ...
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch; gap: 20px">
          <div>
            <p class="size-label">
              stripe
            </p>
              ...
              <div class="progress-cell">
                <div class="progress-bar">
                  <div
                    ...
                    :style="{
                      width: `${value}%`,
                      backgroundColor: value >= 80 ? '#34c759' : value >= 50 ? '#f5a623' : '#ff3b30',
                    }"
                  />
                </div>
      ...
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch; gap: 12px">
          <div style="display: flex; gap: 10px">
            <button class="demo-btn" @click="mockLoading">
              模拟加载（2s）
            </button>
          </div>
...
/>"
    ...
    <section class="doc-section">
      ...
      <div class="doc-preview">
        ...
        <EasyDocCode code="<easy-table :columns=&quot;columns&quot; :data=&quot;[]&quot; empty-text=&quot;暂无数据&quot; />" />
      </div>
    </section>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>title</code> 属性设置表格标题，通过 <code>#toolbar</code> 插槽在右侧放置操作按钮。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch">
...
function handleColumnOrderChange(newColumns: TableColumn[]) {
  console.log('列顺序已更新', newColumns)
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>expandable</code> 开启展开行功能，使用 <code>#expand</code> 插槽自定义展开内容。 支持
        <code>expand-trigger</code> 切换触发方式（默认点击图标展开），
      ...
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch; gap: 12px">
          ...
          <div class="expand-toolbar">
            ...
            <button class="demo-btn" @click="collapseAllRows">
              收起全部
            </button>
          </div>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <code>default-expand-all</code> 默认展开全部， <code>default-expanded-keys</code> 指定默认展开的节点。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch; gap: 12px">
...
function handleTreeExpand(row, expanded) {
  console.log(row.name, expanded ? '展开了' : '收起了')
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        设置 <code>lazy</code> 和 <code>:load</code> 懒加载方法，点击节点时动态加载子数据。 加载过程中显示 loading
        动画。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch; gap: 12px">
...
async function handleLazyLoad(row) {
  ...
  return [
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        通过 <code>fixed: 'left'</code> 或 <code>fixed: 'right'</code> 固定列到左侧或右侧，横向滚动时保持可见。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch">
  ...
  <template #action=&quot;{ row }&quot;>
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <code>summary: 'avg'</code> 指定统计方式，也可通过 <code>summaryText</code> 自定义该列的显示文字。
        合计行固定在表格底部，支持与列固定功能联动。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body" style="flex-direction: column; align-items: stretch">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>合计方式：<code>'sum'</code> 求和 / <code>'avg'</code> 平均值，不设置则不参与合计</td>
