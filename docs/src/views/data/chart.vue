...
const smoothSeries = [{ name: '销售额', data: [320, 280, 450, 380, 520, 480, 590, 620], color: '#3b82f6' }]
...
const revenueSeries = [
  {
    name: '收入',
    data: [128000, 165000, 142000, 198000, 234000, 218000, 276000, 290000, 258000, 312000, 298000, 358000],
  },
]
...
<template>
  <div class="chart-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-desc">
        基于 SVG 原生实现的轻量级图表组件，无需引入任何第三方依赖。支持折线图、柱状图、饼状图、环形图、漏斗图，内置
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        在每个 <code>series</code> 项上设置 <code>color</code>，可统一控制所有柱子该层的颜色； 也可以通过全局
        <code>:colors</code> 按系列顺序批量指定颜色。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <EasyCard shadow="never" :bordered="true">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <code>chartType</code> 指定该系列的展示类型（<code>'bar'</code> 柱状 / <code>'line'</code> 折线）。 组件自动生成
        <strong>双 Y 轴</strong>：左轴对应柱状系列，右轴对应折线系列，两组数据各有独立的量纲范围，不互相干扰。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <EasyCard shadow="never" :bordered="true">
    ...
    <section class="doc-section">
      ...
      <div class="doc-preview">
        <div class="doc-preview__body">
          <div class="chart-row">
            <EasyCard shadow="never" :bordered="true" class="chart-col">
              <EasyChart type="mixed" title="月度访问量 & 转化率" :labels="mixedLabels" :series="mixedSeries2" :height="300" />
            </EasyCard>
            <EasyCard shadow="never" :bordered="true" class="chart-col">
              <EasyChart type="mixed" title="收入 & 费用率（多折线）" :labels="mixedLabels" :series="mixedSeries3" :height="300" />
            </EasyCard>
          </div>
        </div>
        <EasyDocCode
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <code>serie.colors</code> 按数据索引逐柱/逐点精确配色 &nbsp;②&nbsp;<code>serie.color</code> 为整个系列统一着色
        &nbsp;③&nbsp;<code>:colors</code> 全局调色盘按系列原始顺序分配。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <div class="chart-row">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        饼图和环形图开启 <code>:show-label="true"</code> 后，在切片中央显示百分比（切片 &lt; 5% 时自动隐藏以避免拥挤）。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <div class="chart-row">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <b>鼠标拖拽</b>、<b>底部滚动条</b>、<b>滚轮/触控板</b> 三种方式平移视图，Y 轴和网格始终固定。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
...
/>"
    ...
    <section class="doc-section">
      ...
      <div class="doc-preview">
        <div class="doc-preview__body">
          <EasyCard shadow="never" :bordered="true">
            <EasyChart type="funnel" title="注册转化漏斗" subtitle="从曝光到付款各环节转化" :data="funnelData" :height="380" />
          </EasyCard>
        </div>
        <EasyDocCode
          code="<EasyChart
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        在 <code>data</code> 项上单独设置 <code>color</code> 字段，优先级高于全局 <code>:colors</code>。 未设置
        <code>color</code> 的层自动使用 <code>:colors</code> 调色盘或内置默认色，支持混用。
      </p>
      <div class="doc-preview">
        <div class="doc-preview__body">
          <EasyCard shadow="never" :bordered="true">
...
/>"
    ...
    <section class="doc-section">
      ...
      <p class="doc-section__desc">
        ...
        <code>type</code>、<code>label</code>、<code>value</code>、<code>seriesName</code>、<code>index</code>、<code>extra</code>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>图表类型</td>
              <td>
                <code>'line' | 'bar' | 'stack' | 'hbar' | 'pie' | 'donut' | 'funnel' | 'gauge' | 'mixed'</code>
              </td>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <code>{ type, label, value, seriesName?, index, extra? }</code><br><small>extra：series/data 每项中的自定义字段（排除 name/data/value/color/areaFill）</small>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td><code>color</code></td>
              <td>
                单项颜色（可选），优先级高于全局 <code>:colors</code> 调色盘。可混用：未设置 color 的项使用 :colors 兜底
              </td>
              <td><code>string</code></td>
            </tr>
            <tr>
