...
<template>
  <div class="system-page">
    ...
    <div class="search-bar">
      <EasyInput
        v-model="searchForm.keyword" placeholder="搜索部门名称/编码" clearable style="width: 240px"
    ...
    <el-table
      ref="tableRef" v-loading="loading" :data="treeData" row-key="id" stripe border default-expand-all
    ...
    >
      <el-form ref="formRef" :model="dialog.form" :rules="formRules" label-width="100px">
        ...
        <el-form-item label="上级部门" prop="parentId">
          <el-tree-select
            v-model="dialog.form.parentId" :data="parentOptions"
