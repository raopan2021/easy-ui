...
<template>
  <div class="system-page">
    ...
    <div class="search-bar">
      <EasyInput
        v-model="searchForm.keyword" placeholder="搜索字段名" clearable style="width: 200px"
        @keyup.enter="handleSearch" @clear="handleSearch"
      />
      <EasySelect
        v-model="searchForm.tableName" placeholder="数据表" clearable :options="tableOptions"
        style="width: 180px" @change="handleSearch"
      />
      <EasySelect
        v-model="searchForm.permType" placeholder="权限类型" clearable
    ...
    <el-dialog
      v-model="dialog.visible" :title="dialog.isEdit ? '编辑字段权限' : '新增字段权限'" width="500px"
