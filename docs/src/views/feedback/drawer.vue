...
<EasyDrawer v-model=&quot;visible&quot; title=&quot;大型&quot; size=&quot;80%&quot;>...</EasyDrawer>"
  ...
  <p>这是一个没有遮罩的抽屉，背景完全透明。</p>
      ...
      <EasyDrawer
        v-model="noMaskVisible" title="固定面板" direction="left" :show-mask="false" :show-footer="false"
        :size="260"
      >
...
function handleAfterClose() {
  console.log('抽屉已完全关闭')
      ...
      <EasyDrawer
        v-model="eventVisible" title="事件监听" @open="handleOpen" @opened="handleOpened" @close="handleClose"
        @after-close="handleAfterClose"
      >
    ...
    <section class="doc-section">
      ...
      <EasyDrawer v-model="formVisible" title="编辑用户" direction="right">
        <div class="demo-form">
          ...
          <div class="demo-form__item">
            ...
            <EasySelect
              v-model="formData.department" placeholder="请选择部门" size="default"
          ...
          <div class="demo-form__item">
            ...
            <EasySelect
              v-model="formData.role" placeholder="请选择角色" size="default"
      ...
      <!-- 确认抽屉 -->
      <EasyDrawer
        v-model="confirmVisible" title="操作确认" direction="bottom" :size="320" :show-header="false"
        :show-footer="false"
      >
