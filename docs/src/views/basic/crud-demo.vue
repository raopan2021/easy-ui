...
<template>
  <div class="crud-demo">
    <!-- 搜索区域 -->
    <EasySearchForm
      ref="searchFormRef" :items="searchItems" :model-value="searchData" :show-expand-button="false"
      @search="handleSearch" @reset="handleReset"
    />

    <!-- 表格区域 -->
    <EasyTable
      ref="tableRef" :data="tableData" :columns="tableColumns" :loading="tableLoading" :total="total"
    ...
    <!-- 新增/编辑弹窗 -->
    <EasyModal
      v-model="formModal.visible" :title="formModal.isEdit ? '编辑用户' : '新增用户'" width="520px"
    ...
    <!-- 查看详情弹窗 -->
    <EasyModal
      v-model="viewModal.visible" title="用户详情" width="50%" :show-confirm="false"
    ...
    <!-- 删除确认弹窗 -->
    <EasyModal
      v-model="deleteModal.visible" title="确认删除" width="400px" @confirm="confirmDelete"
