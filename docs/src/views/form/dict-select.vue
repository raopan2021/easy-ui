...
const propsList = [
  ...
  { name: 'multiple', type: 'boolean', default: 'false', desc: '是否开启多选模式' },
  {
    ...
    type: '\'array\' | \'string\'',
    default: '\'array\'',
    desc: '多选时输出格式：array 为字符串数组，string 为逗号拼接',
  },
  ...
  { name: 'value-field', type: 'string', default: '\'id\'', desc: '字典数据中用作选项值的字段名' },
  {
    ...
    type: 'string',
    default: '\'id\'',
    desc: 'v-model 最终返回值字段名，默认返回 id，可设为 labelValue 返回英文代码',
  },
]
</script>
...
<template>
  <div class="dict-select-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-desc">
        根据字典类型自动请求并渲染下拉选项，无需手动维护选项列表，支持单选/多选，可对接任意后端字典接口。
      </p>
    </div>
    ...
    <div class="doc-section">
      ...
      <div class="doc-preview">
        <div class="preview-row wrap">
          <easy-dict-select
            v-model="multi1" dict-type="approve_status" multiple collapse-tags collapse-tags-tooltip
    ...
    <div class="doc-section">
      ...
      <div class="doc-preview">
        <div class="preview-row wrap">
          <easy-dict-select
            v-model="multi2" dict-type="order_status" multiple value-format="string" filterable
    ...
    <div class="doc-section">
      ...
      <p class="doc-section__desc">
        组件默认用 <code>labelName</code>（显示文本）作为下拉选项， 通过 <code>label-field</code> 可切换为
        <code>labelValue</code>（英文代码）。
      </p>
      <div class="doc-preview">
        <div class="preview-row">
          <easy-dict-select
            v-model="custom1" dict-type="user_status" label-field="labelValue"
    ...
    <div class="doc-section">
      ...
      <p class="doc-section__desc">
        默认 <code>return-field="id"</code>，返回数字/字符串 ID。 设为
        <code>return-field="labelValue"</code> 则返回英文代码（如 NORMAL/DISABLED）。
      </p>
      <div class="doc-preview">
        <div class="preview-row">
          <easy-dict-select
            v-model="custom2" dict-type="user_status" return-field="labelValue"
    ...
    <div class="doc-section">
      ...
      <div class="doc-preview">
        <div class="preview-row wrap">
          <easy-dict-select
            v-model="event1" dict-type="role_type" placeholder="选择角色" style="width: 220px"
            @change="handleChange"
          />
