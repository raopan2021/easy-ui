...
<template>
  <EasyDrawer
    v-model="drawerVisible" title="切换布局风格" direction="right" size="360px" :show-header="true"
    :show-close="true" :show-mask="true" :close-on-click-modal="true"
  >
    <div class="layout-selector">
      <div
        v-for="layout in layouts" :key="layout.key" class="layout-item"
      ...
      >
        <div class="layout-item__preview">
          ...
          <div class="layout-item__menu" :style="{ background: layout.menuBg }">
            <div
              v-for="i in 3" :key="i" class="layout-item__menu-line"
